...
import headerImg from "../assets/img/prh_new.png";
...
export const Banner = () => {
  ...
  const toRotate = ["Student", "Tech Enthusiast", "Developer"];
  const period = 2000;
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>
                    {`Hi! I'm Praharsh,`} <br />
                    {`a`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Student", "Tech Enthusiast", "Developer" ]'>
